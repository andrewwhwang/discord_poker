...
from card import Card, CardCreationError
...
class Hand(object):
    ...
    * best_cards - the best (at most 5) cards that consist the actual hand
    ...
    def __iadd__(self, other):
        ...
        raise HandCreationError('hand can only be added by list of cards')
    ...
    def __lt__(self, other):
        ...
        return (self.value, self.best_cards) < (other.value, other.best_cards)
